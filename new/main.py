...
def main():
    ...
    output = cserver.putVideo('Processed', width=480, height=360)
    output_unprocessed = cserver.putVideo('Raw', width=480, height=360)
    ...
    while True:
        ...
        output_image = cv2.resize(frame, (480, 360))
        ...
        if best_detection:
            ...
            cv2.circle(img=output_image, center=(best_detection["x"], best_detection["y"]), radius=best_detection["r"], color=(0, 255, 0), thickness=4)
